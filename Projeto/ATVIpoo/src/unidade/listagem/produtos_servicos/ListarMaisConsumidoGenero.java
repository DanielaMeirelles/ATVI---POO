package unidade.listagem.produtos_servicos;
...
import unidade.listagem.Sortable;

public class ListarMaisConsumidoGenero extends Listagem implements Sortable {
	...
	public ListarMaisConsumidoGenero(List<Cliente> clientes, List<Produto> produtos, List<Servico> servicos) {
